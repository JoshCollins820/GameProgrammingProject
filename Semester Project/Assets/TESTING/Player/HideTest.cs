...
public class HideTest : MonoBehaviour
{
    ...
    void OnTriggerEnter(Collider other)
    {
        if(other.CompareTag("Player"))
        {
            ...
            Player.GetComponent<PlayerUITest>().DisplayInteractUI("Hide");
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        if(other.CompareTag("Player"))
        {
            ...
            Player.GetComponent<PlayerUITest>().DisableInteractUI();
        }
    }
    ...
    void EnterHidingSpot()
    {
        ...
        Player.GetComponent<PlayerUITest>().DisableHintUI(); // hide hint ui
        Player.GetComponent<PlayerUITest>().DisplayInteractUI("Exit"); // display exit text
    }
    ...
    void LeaveHidingSpot()
    {
        ...
        Player.GetComponent<PlayerUITest>().DisplayInteractUI("Hide"); // display hide text
    }
